...
def get_parameters():
    ...
    system_file = "/home/jbieri/CME_lab/repos/pl-validation/mol2/30_mers/PCPDTPT_nC16_30mer.mol2"
    ff_file = "/home/jbieri/CME_lab/repos/pl-validation/xml/PCPDTPT_nC16.xml"
...
def main():
    project = signac.init_project("PCPDTPT_nC16") # Set the signac project name
